...
This paper:(https://onlinelibrary.wiley.com/doi/full/10.1002/ece3.9495) states that "Since the 1970s, the lesser yellowlegs (Tringa flavipes) has experienced a pronounced reduction in abundance of ~63%." However, my data showed an increase in lesser yellowlegs over the past decade, showing that the avian point count data is likely not a reliable indicator of total species population size.   
