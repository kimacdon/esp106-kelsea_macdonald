...
agg <- aggregate(SpeciesTotal ~ Year, data=us.yl, FUN=mean)
#Actually it doesnt make sense to sum these because the numbers may only be increasing due to increased measurements taken, maybe use mean?
```
